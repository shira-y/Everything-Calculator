...
const CalculatorLibrary = () => {
  ...
  if (isLoading) {
    return (
      <div className="w-full max-w-4xl mx-auto mt-12 p-6 bg-background rounded-lg shadow-md">
        <h2 className="text-2xl font-bold mb-6 text-foreground text-center">Ready-to-Use Calculators</h2>
  ...
  if (isError) {
    ...
    return (
      <div className="w-full max-w-4xl mx-auto mt-12 p-6 bg-background rounded-lg shadow-md text-center text-destructive">
        <h2 className="text-2xl font-bold mb-6 text-foreground">Error Loading Calculators</h2>
    ...
    <div className="w-full max-w-4xl mx-auto mt-12 p-6 bg-background rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {predefinedCalculators?.map((calculator) => (
          <Card
            key={calculator.id}
            className="cursor-pointer hover:shadow-lg hover:bg-accent transition-all duration-200 ease-in-out"
